            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-3"> <a href="{{ route('boxes.edit', $box->id) }}" class="btn btn-light">Modifier</a></td>
                        <td class="p-3"><a href="{{ route('boxes.show', $box->id) }}" class="btn btn-light">Voir</a></td>
                    </tr>
